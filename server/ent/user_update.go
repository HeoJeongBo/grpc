...
func (_u *UserUpdate) AddItemIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveItemIDs(ids ...string) *UserUpdate {
...
// AddItemIDs adds the "items" edge to the Item entity by IDs.
func (_u *UserUpdateOne) AddItemIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddItemIDs(ids...)
	return _u
}
...
// RemoveItemIDs removes the "items" edge to Item entities by IDs.
func (_u *UserUpdateOne) RemoveItemIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveItemIDs(ids...)
	return _u
}
