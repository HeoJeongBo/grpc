...
func (_u *ItemUpdate) SetStatus(v int32) *ItemUpdate {
...
func (_u *ItemUpdate) SetNillableStatus(v *int32) *ItemUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *ItemUpdate) AddStatus(v int32) *ItemUpdate {
...
func (_u *ItemUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedStatus(); ok {
		_spec.AddField(item.FieldStatus, field.TypeInt32, value)
	}
...
// SetStatus sets the "status" field.
func (_u *ItemUpdateOne) SetStatus(v int32) *ItemUpdateOne {
	_u.mutation.ResetStatus()
	_u.mutation.SetStatus(v)
	return _u
}
...
// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *ItemUpdateOne) SetNillableStatus(v *int32) *ItemUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// AddStatus adds value to the "status" field.
func (_u *ItemUpdateOne) AddStatus(v int32) *ItemUpdateOne {
	_u.mutation.AddStatus(v)
	return _u
}
